...
namespace WebAppComp3011.Controllers
{
    ...
    [ApiController]
    public class FragrancesService : ControllerBase
    {
        ...
        public async Task<ActionResult<Fragrance>> GetFragrance(int id)
        {
            ...
            await using (var cn = new SqliteConnection(connectString))
            {
                ...
                cmd.CommandText = "SELECT * FROM perfumeData WHERE perfumeId = @id";
                cmd.Parameters.AddWithValue("@id", id); // insert param used in the init query
        ...
        /// <summary>
        ///  Return fragrances by accord (case-insensitive, partial match)
        /// </summary>
        // GET: api/Fragrances/accord
        ...
        /// <summary>
        ///  Return fragrances by their note, top middle or base (case-insensitive, partial match)
        /// </summary>
        // GET: api/Fragrances/note/
        [HttpGet("note/{note}")]
    ...
    ";
        ...
        /// <summary>
        ///  Add a new fragrance to the db, return the id
        /// </summary>
        // POST: api/Fragrances
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        ...
        /// <summary>
        ///  Given an id, delete from the db
        /// </summary>
        ...
        // Read the notes of a perfume from the perfumeNotes table and return as a Notes object
