...
namespace WebAppComp3011.Services
{
    ...
    public class UserProfileController : ControllerBase
    {
        ...
        /// </summary>
        // GET: api/api/userProfile/username/{username}
