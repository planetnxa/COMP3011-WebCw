...
namespace WebAppComp3011.Services
{
    ...
    [ApiController]
    public class UserCabinetService : ControllerBase
    {
        ...
        /// <summary>
        ///  Get a specific user cabinet entry by id
        /// </summary>
        ...
        /// <summary>
        ///  get all cabinet entries for a specifc user - giving a user cabine
        /// </summary>
        ...
        /// <summary>
        ///  Given an id, update the corresponding user cabinet entry with the provided data
        /// </summary>
        ...
        public async Task<IActionResult> PutUserCabinet([FromRoute] int id, [FromBody] UserCabinet entry)
        {
            ...
            if (rowsAffected == 0)
            {
                if (!UserCabinetExists(id)) //check if entry exists or no
                    return NotFound();
            }
        ...
        /// <summary>
        ///  Given an id, delete cabinet entry from the db
        /// </summary>
        ...
        private bool UserCabinetExists(int id)
        {
            ...
            using (var cn = new SqliteConnection(connectString))
            {
                ...
                cmd.CommandText = "SELECT 1 FROM userCabinet WHERE id = @id"; // id unique hence it works
                cmd.Parameters.AddWithValue("@id", id);
